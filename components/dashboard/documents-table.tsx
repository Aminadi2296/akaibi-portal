            ...
            <table className="w-full table-fixed text-sm">
              <thead>
                <tr className="border-b bg-muted/40 text-left text-muted-foreground">
                  <th className="w-[200px] px-4 py-3 font-medium">Document</th>
                  {schema.map((field) => (
                    <th key={field.key} className="w-[140px] px-4 py-3 font-medium">
                      {field.label}
                    </th>
                  ))}
                  <th className="w-[100px] px-4 py-3 font-medium">Uploaded</th>
